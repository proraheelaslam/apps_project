            ...
            <div class="col-md-12">
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="font-dark"></i>
                            <span class="caption-subject font-dark sbold uppercase">Manage Application Setting</span>
                        </div>
                    </div>
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <tr role="row" class="filter">
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control input-inline input-medium" name="app_setting_name" placeholder="Name" value="<?php echo e(session('app_setting_name_filter')); ?>">
...
<?php $__env->startSection("script"); ?>
	<script type="text/javascript">
		let url = '<?php echo e(url('admin/app_settings/get')); ?>';
		let columns = [
				{data: 'name', name: 'name'},
		...
		createDatable(url, columns, [0], "app_setting");
