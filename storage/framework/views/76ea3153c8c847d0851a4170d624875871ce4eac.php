                            ...
                            <tr role="row" class="filter">
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control input-inline input-medium" name="business_report_reason_name" placeholder="Name" value="<?php echo e(session('business_report_reason_name_filter')); ?>">
...
<?php $__env->startSection("script"); ?>
	<script type="text/javascript">
		let url = '<?php echo e(url('admin/business_report_reason/get')); ?>';
		let columns = [
