                            ...
                            <tr role="row" class="filter">
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control input-inline input-medium" name="business_category_name" placeholder="Name" value="{{session('business_category_name_filter')}}">
...
@section("script")
	<script type="text/javascript">
		let url = '{{ url('admin/business_categories/get') }}';
		let columns = [
				{data: 'name', name: 'name'},
