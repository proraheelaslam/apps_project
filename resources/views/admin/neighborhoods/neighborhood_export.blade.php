...
@section('content')
            ...
            <div class="col-md-12 ">
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        ...
                        <a href="{{asset('upload/csv/neighborhood_sample.csv')}}" class="btn btn-primary pull-right btn-circle">Download Sample CSV</a>
                    </div>
                    <div class="portlet-body form">
                        ...
                        @endif
                            {!! Form::open(['url'=>'admin/neighborhood/export','method' => 'post','class'=>
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            {!! Form::text('neighborhood_name','',['class'=>'form-control','placeholder'=>'Neighborhood Name','required'=>'required']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Enter Location</label>
                                        <div class="col-md-9">
                                            {!! Form::text('neighborhood_address','',['class'=>'form-control','id'=>'pac-input','placeholder'=>'Enter a location','required'=>'required']) !!}
                                        </div>
                                    </div>
    ...
    @if(Session::has('status'))
      <?php  Session::forget('status'); ?>
        <script>
            window.location = "{{url('admin/neighborhood/export/create')}}";
        </script>
    @endif
@endsection
@section('script')
