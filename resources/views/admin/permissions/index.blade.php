            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        ...
                        {{--<a href="{{url('admin/permissions/create')}}" type="button" class="btn btn-primary pull-right">Add Permission</a>--}}
                    </div>
                            ...
                            <tr role="row" class="filter">
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control input-inline input-medium" name="permission_name" placeholder="Name" value="{{session('permission_name_filter')}}">
...
@section('script')
    <script>
        let url = '{{ url('admin/permissions/get') }}';
        let columns = [
            {data: 'name', name: 'name'},
