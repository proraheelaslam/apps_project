...
<head>
    ...
    <link href="<?php echo e(asset('theme/pages/css/error.min.css')); ?>" rel="stylesheet" type="text/css" />
...
<div class="page-inner">
    <img src="<?php echo e(asset('theme/pages/media/pages/earth.jpg')); ?>" class="img-responsive" alt=""> </div>
<div class="container error-404">
    <h1>404</h1>
    <p class="text-grey-darker text-2xl md:text-3xl font-light mb-8 leading-normal">
        Sorry, the page you are looking for could not be found.                    </p>
    <p>
        <a href="<?php echo e(url('admin/home')); ?>" class="btn red btn-outline"> Return home </a>
        <br> </p>
</div>
