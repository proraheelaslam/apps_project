                            ...
                            <tr role="row" class="filter">
                                <td>
                                    <div class="input-group width_100">
                                        <input type="text" class="form-control input-inline input-sm width_100" name="neighborhood_name" placeholder="Name" value="<?php echo e(session('neighborhood_name_filter')); ?>">
                                ...
                                <td>
                                    <div class="input-group width_100">
                                        <input type="text" class="form-control form-filter input-sm width_100" name="neighborhood_address" placeholder="Address" value="<?php echo e(session('neighborhood_address_filter')); ?>">
                                    </div>
                                </td>
                                <td>
                                    <div class="input-group width_100">
                                        <input type="number" class="form-control form-filter input-sm width_100" name="neighborhood_total_users" placeholder="Total Users" value="<?php echo e(session('neighborhood_total_users_filter')); ?>" min="0"   onkeypress="return event.charCode != 45">
                                    </div>
                                </td>
                                <td>
                                    <div class="input-group width_100">
                                        <select name="verified_by_admin" class="form-control form-filter input-sm width_100" id="input-status">
                                            <option value="" <?php echo e(session("verified_by_admin_filter") == "" ? "selected" : ""); ?>>Select Status</option>
                                            <option value="0" <?php echo e(session("verified_by_admin_filter") == "0" ? "selected" : ""); ?>>Pending</option>
                                            <option value="1" <?php echo e(session("verified_by_admin_filter") == "1" ? "selected" : ""); ?>>Approved</option>
                                        </select>
                                    </div>
                                </td>
                                <td>
...
<?php $__env->startSection('script'); ?>
    <script>
        let url = '<?php echo e(url('admin/neighborhoods/get')); ?>';
        console.log("url", url);
        let columns = [
