                            ...
                            <tr role="row" class="filter">
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control input-inline input-medium" name="classified_category_category_name" placeholder="Name" value="{{session('classified_category_category_name_filter')}}">
...
@section("script")
	<script type="text/javascript">
		let url = '{{ url('admin/classified_category/get') }}';
		let columns = [
