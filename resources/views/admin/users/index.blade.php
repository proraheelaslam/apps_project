                            ...
                            <tr role="row" class="filter">
                                <td>
                                    <div class="input-group width_100">
                                        <input type="text" class="form-control input-inline input-small width_100" name="full_name" placeholder="Name" value="{{session('full_name_filter')}}">
                                ...
                                <td>
                                    <div class="input-group width_100">
                                        <input type="text" class="form-control input-inline input-small width_100" name="user_email" placeholder="Email" value="{{session('user_email_filter')}}">
                                    </div>

                                </td>
                                <td>
                                    <div class="input-group width_100">
                                        <input type="text" class="form-control form-filter input-small width_100" name="user_address" placeholder="Address" value="{{session('user_address_filter')}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="input-group width_100">
                                        <input type="text" class="form-control form-filter input-small width_100" name="user_phone" placeholder="Phone" value="{{session('user_phone_filter')}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="input-group width_100">
                                        <select name="user_is_address_verified" class="form-control form-filter input-small width_100" id="address-status">
                                            <option value="" {{ session("user_is_address_verified_filter") === "" ? "selected" : ""}}>Select Status</option>
                                            <option value="0" {{ session("user_is_address_verified_filter") === "0" ? "selected" : ""}}>Pending</option>
                                            <option value="1" {{ session("user_is_address_verified_filter") === "1" ? "selected" : ""}}>Waiting</option>
                                            <option value="2" {{ session("user_is_address_verified_filter") === "2" ? "selected" : ""}}>Verfied</option>
                                        </select>
                                    </div>
                                </td>
                                <td valign="top">
...
@section('script')
    <script>
        let url = '{{ url('admin/all_users/list/get') }}';
        let columns = [
