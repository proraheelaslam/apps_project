    ...
    <div class="page-content">
        ...
        <h3 class="page-title"> Update Neighbourhood Detail
            ...
            <div class="form-actions pull-right">
                <a href="{{ url("admin/neighborhoods") }}" class="btn default" id="cancel">Cancel</a>
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            @if($neighborhoods->verified_by_admin == 0)
                                <button onclick="verifyNeighborhood('{{$neighborhoods->_id}}')" type="button" class="btn btn-primary btn-circle">Verify Neighborhood</button>
                            @endif
                        </div>
                    </div>
                        ...
                        <form class="form-horizontal" role="form">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control input-sm" name="name" placeholder="Name" value="{{$neighborhoods->neighborhood_name}}" maxlength="100" required=""> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Address: </label>
                                    <div class="col-md-9">
                                        <textarea class="form-control" rows="3" name="address" maxlength="200" placeholder="Address">{{trim($neighborhoods->neighborhood_address)}}</textarea> 
                                    </div>
                                </div>
                                <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a title="User Detail" href="{{url('admin/users'.'/'.encodeId($neighborhoods->createdBy->_id))}}" class="btn btn-sm btn-circle btn-default btn-editable">
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="row static-info">
                            ...
                            <div class="col-md-7 value"> j{{$neighborhoods->createdBy->user_email}} </div>
                        </div>
                        <div class="row static-info">
...
@section('script')
    <script>
        ...
        var newNeighbourhoodId = {!! json_encode($neighborhoods->_id) !!};
        var backUrl = {!! json_encode(url('admin/neighborhoods')) !!};
