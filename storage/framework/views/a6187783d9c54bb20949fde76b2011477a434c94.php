    ...
    <div class="row bs-reset">
        <div class="col-md-6 login-container bs-reset">
            ...
            <div class="login-content">
                ...
                <form action="<?php echo e(url('/admin/password/email')); ?>" class="login-form" method="post">
                    ...
                    <div class="form-actions">
                        <a href="<?php echo e(url('admin/login')); ?>" id="back-btn" class="btn blue btn-outline">Back</a>
