                            ...
                            <tr role="row" class="filter">
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control input-inline input-medium" name="app_notification_name" placeholder="Name" value="<?php echo e(session('app_notification_name_filter')); ?>">
...
<?php $__env->startSection("script"); ?>
	<script type="text/javascript">
		let url = '<?php echo e(url('admin/app_notification/get')); ?>';
		let columns = [
				{data: 'name', name: 'name'},
