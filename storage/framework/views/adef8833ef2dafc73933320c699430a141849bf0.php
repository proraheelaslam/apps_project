                            ...
                            <tr role="row" class="filter">
                                <td>
                                    <div class="input-group width_100">
                                        <input type="text" class="form-control input-inline input-sm width_100" name="nu_full_name" placeholder="Name" value="<?php echo e(session('nu_full_name_filter')); ?>">
                                ...
                                <td>
                                    <div class="input-group width_100">
                                        <input type="text" class="form-control input-inline input-sm width_100" name="nu_user_email" placeholder="Email" value="<?php echo e(session('nu_user_email_filter')); ?>">
                                    </div>
                                     
                                </td>
                                <td>
                                    <div class="input-group width_100">
                                        <input type="text" class="form-control input-inline input-sm width_100" name="nu_user_address" placeholder="Address" value="<?php echo e(session('nu_user_address_filter')); ?>">
                                    </div>
                                </td>
                                <td>
                                    <div class="input-group width_100">
                                        <input type="text" class="form-control input-inline input-sm width_100" name="nu_user_phone" placeholder="Phone" value="<?php echo e(session('nu_user_phone_filter')); ?>">
                                    </div>
                                </td>
                                <td>
                                    <div class="input-group width_100">
                                        <select name="nu_user_address_status" class="form-control input-inline input-sm width_100" id="address-status">
                                            <option value="" <?php echo e(session("nu_user_address_status_filter") === "" ? "selected" : ""); ?>>Select Status</option>
                                            <option value="Pending" <?php echo e(session("nu_user_address_status_filter") === "Pending" ? "selected" : ""); ?>>Pending</option>
                                            <option value="Approved" <?php echo e(session("nu_user_address_status_filter") === "Approved" ? "selected" : ""); ?>>Approved</option>
                                        </select>
                                    </div>
                                </td>
                                <td>
...
<?php $__env->startSection('script'); ?>
    <script>
        let url = '<?php echo e(url('admin/neighborhoods/users/get/'.$id)); ?>';
        let columns = [
