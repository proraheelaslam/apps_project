                            ...
                            <tr role="row" class="filter">
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control input-inline input-medium" name="app_setting_name" placeholder="Name" value="{{session('app_setting_name_filter')}}">
...
@section("script")
	<script type="text/javascript">
		let url = '{{ url('admin/app_settings/get') }}';
		let columns = [
				{data: 'name', name: 'name'},
