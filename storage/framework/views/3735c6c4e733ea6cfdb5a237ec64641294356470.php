                            ...
                            <tr role="row" class="filter">
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control input-inline input-medium" name="push_notify_name" placeholder="Name" value="<?php echo e(session('push_notify_name_filter')); ?>">
...
<?php $__env->startSection("script"); ?>
	<script type="text/javascript">
		let url = '<?php echo e(url('admin/app/push_notifications/get')); ?>';
		let columns = [
				{data: 'name', name: 'name'},
