            ...
            <div class="col-md-12">
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="font-dark"></i>
                            <span class="caption-subject font-dark sbold uppercase">Manage Business Categories</span>
                        </div>
                    </div>
                    <div class="portlet-title">
                        <div class="caption">
                        ...
                        <div class="actions">
                            <div class="btn-group">
                                 <?php
                                    $url = url('admin/business_categories/add');
                                    if (Auth::user()->can('add business_category')) {
                            ...
                            <tr role="row" class="filter">
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control input-inline input-medium" name="business_category_name" placeholder="Name" value="<?php echo e(session('business_category_name_filter')); ?>">
...
<?php $__env->startSection("script"); ?>
	<script type="text/javascript">
		let url = '<?php echo e(url('admin/business_categories/get')); ?>';
		let columns = [
				{data: 'name', name: 'name'},
				{data: 'action', name: 'action'},
			];

		createDatable(url, columns, [0], "business_categories");
