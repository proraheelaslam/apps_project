                            ...
                            <tr role="row" class="filter">
                                <td>
                                    <div class="input-group width_100">
                                        <input type="text" class="form-control input-inline input-small width_100" name="classified_title" placeholder="Title" value="<?php echo e(session('classified_title_filter')); ?>">
                                        <input type="hidden" class="form-control form-filter input-sm" name="set_session" placeholder="set_session" value="1">
                                    </div>
                                </td>
                                <td>
                                    <div class="input-group width_100">
                                        <input type="number" class="form-control input-inline input-small width_100" name="classified_price" placeholder="Price" value="<?php echo e(session('classified_price_filter')); ?>">
                                    </div>
                                </td>
                                <td>
                                    <div class="input-group width_100">
                                        <select name="classified_neighborhood" class="form-control form-filter input-small width_100" id="classified-neighborhood">
                                            <option value="" <?php echo e(session("classified_neighborhood_filter") === "" ? "selected" : ""); ?>>Select Neighborhood</option>
                                            <?php $__currentLoopData = $neighborhoods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $neighborhood): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($neighborhood->_id); ?>" <?php echo e(session("classified_neighborhood_filter") === $neighborhood->_id ? "selected" : ""); ?>><?php echo e($neighborhood->neighborhood_name); ?></option>
                                ...
                                <td>
                                    <div class="input-group width_100">
                                        <input type="text" class="form-control input-inline input-small width_100" name="classified_created_by" placeholder="Created By" value="<?php echo e(session('classified_created_by_filter')); ?>">
                                    </div>
                                </td>
                                <td>
...
<?php $__env->startSection("script"); ?>
	<script type="text/javascript">
		let url = '<?php echo e(url('admin/classifieds/get')); ?>';
		let columns = [
