                            ...
                            <tr role="row" class="filter">
                                <td>
                                    <div class="input-group width_100">
                                        <input type="text" class="form-control input-inline input-small width_100" name="message_upost_title" placeholder="Subject" value="<?php echo e(session('message_upost_title_filter')); ?>">
                                        <input type="hidden" class="form-control form-filter input-sm" name="set_session" placeholder="set_session" value="1">
                                    </div>
                                </td>
                                <td>
                                    <div class="input-group width_100">
                                        <input type="text" class="form-control input-inline input-small width_100" name="message_user" placeholder="User" value="<?php echo e(session('message_user_filter')); ?>">
                                    </div>
                                </td>
                                <td>
                                    <div class="input-group width_100">
                                        <select name="message_neighborhood_name" class="form-control form-filter input-small width_100" id="message-neighborhood">
                                            <option value="" <?php echo e(session("message_neighborhood_filter") === "" ? "selected" : ""); ?>>Select Neighborhood</option>
                                            <?php $__currentLoopData = $neighborhoods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $neighborhood): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($neighborhood->_id); ?>" <?php echo e(session("message_neighborhood_name_filter") == $neighborhood->_id ? "selected" : ""); ?>><?php echo e($neighborhood->neighborhood_name); ?></option>
